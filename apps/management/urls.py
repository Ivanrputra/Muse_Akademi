...
urlpatterns = [
	...
	path('course/create/', views.CourseCreate.as_view(http_method_names=['get','post']),name='course-create'),
	...
	path('classroom/<int:pk>/students/sendemail', views.CourseStudentsSendEmail.as_view(http_method_names=['post']),name='course-students-email'),
	
	path('mentor/', views.MentorManagement.as_view(http_method_names=['get']),name='mentor-management'),
	path('mentor/create', views.MentorManagementCreate.as_view(http_method_names=['get','post']),name='mentor-create'),
	...
	path('mitra/', 			views.MitraManagement.as_view(http_method_names=['get']),name='mitra-management'),
	path('mitra/<int:pk>', 	views.MitraManagementUpdate.as_view(http_method_names=['get','post']),name='mitra-update'),
