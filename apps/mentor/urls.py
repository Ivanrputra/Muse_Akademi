...
urlpatterns = [
	...
	path('classroom/evaluation/library/<int:library_pk>/create', views.EvaluationCreate.as_view(http_method_names=['get','post']),name='evaluation-create'),
	path('classroom/evaluation/<int:pk>/update', views.EvaluationUpdate.as_view(http_method_names=['get','post']),name='evaluation-update'),
